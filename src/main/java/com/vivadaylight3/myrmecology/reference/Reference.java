...
public class Reference {
    ...
    public static final int GUI_ID_INCUBATOR = 0, GUI_ID_BREEDINGCHAMBER = 1,
	    GUI_ID_FORMICARIUM = 2, GUI_ID_MYRMOPAEDIA = 3, GUI_ID_BOOK = 4;
    public static final String MOD_ID = "myrmecology",
	    ...
	    UPDATE_URL = "@UPDATE_URL@", USER_UPDATE_URL = "@USER_UPDATE_URL@";
}